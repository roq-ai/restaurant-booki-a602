  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Discover Restaurant Booking Engine - Your ultimate solution for seamless table reservations and menu management, revolutionizing the way restaurants operate."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Discover Restaurant Booking Engine - Your ultimate solution for seamless table reservations and menu management, revolutionizing the way restaurants operate.`}
            </Text>
            <Box
